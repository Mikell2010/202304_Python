...
person = {'name': 'John', 'location': 'Salt Lake', 'age': 37, 'is_balding': False} #variable declaration, dictonary initialized 
...
print(person['name']) #print to console, dictonary access to value
...
for x in range(5): #for loop start at 0 up to until 5
    print(x) #print to console
for x in range(2,5): #for loop start at 2 up to until 5
    print(x) #print to console
for x in range(2,10,3): #for loop start at 2 up to until 10, increment by 3
    print(x) #print to console
...
for topping in pizza_toppings: #for loop trought a list
...
def print_hello_ten_times(): #function declaration
    for num in range(10):#for loop start at 0 up to until 10
...
print_hello_x_times(4)#function call orgument of 4 
